...
const LoginScreen = ({navigation}) => {
  ...
  return (
    <KeyboardAvoidingView style={styles.container}>
      ...
      <Text style={styles.zelo}>KMess</Text>
      <View style={styles.inputContainer}>
            ...
            return (
              <>
                <InputField
                  ...
                  autoFocus
                  onChangeText={handleChange('employid')}
                  value={values.employid}
                  error={errors.employid}
                  leftIcon={
                    <Icon
                      name="user"
                      type="antdesign"
        ...
        <View style={styles.registerContainer}>
          <Text style={{fontSize: 15}}>Phần mềm chỉ phục vụ cho công ty Kama. </Text>
