...
export default function MeScreen({navigation}) {
  ...
  const handleEmployid = () => {
    const employid = userProfile?.employid;
    console.log(employid);
    let employee = '';
    if (employid) {
      if (!employid.includes('@')) {
        employee = employid;
      }
    }
    return employee;
      ...
      <ScrollView>
        ...
        <View style={styles.detailsContainer}>
          ...
          <ListItem>
            ...
            <Text style={styles.content}>{handleEmployid()}</Text>
          </ListItem>
          <ListItem>
            <Text style={styles.title}>Phòng ban</Text>
            <Text style={styles.content}>{handleDepartment()}</Text>
          </ListItem>
          <ListItem>
